...
import { Plus, UserPlus, UserMinus, Clock, Hash, Trash2 } from 'lucide-react'
...
export default function PlayersScreen({ players, setPlayers, currentMatch }: PlayersScreenProps) {
    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b p-4">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-bold text-gray-900">Team Players</h1>
          <button
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6 pb-20">
        ...
        {isAddingPlayer && (
          <div className="bg-white rounded-lg shadow-sm border p-4">
            <h3 className="font-medium text-gray-900 mb-4">Add New Player</h3>
